...
export class PublicService {
  ...
  public userLogin(userEmail: any, userMobNumber: any, userPassword: any): Observable<any>{
    return this.http.get(`${this.publicUrl}/user/login/${userEmail}/${userMobNumber}/${userPassword}`);
  }
